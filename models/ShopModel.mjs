export class ShopModel extends foundry.abstract.TypeDataModel {
    static defineSchema() {
        ...
        return {
            ...
            charisma: new fields.NumberField({ required: true, default: 1 }),
            negotiation: new fields.NumberField({ required: true, default: 1 }),
            connection: new fields.NumberField({ required: true, default: 1 }),
            loyalty: new fields.NumberField({ required: true, default: 1 }),
